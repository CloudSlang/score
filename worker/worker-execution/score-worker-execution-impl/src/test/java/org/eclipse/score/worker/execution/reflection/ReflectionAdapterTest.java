...
public class ReflectionAdapterTest {
	...
	public void executeControlActionTest() {
		ControlActionMetadata metadata = new ControlActionMetadata("org.eclipse.score.worker.execution.reflection.ReflectionAdapterTestHelper", "myMethod_1");
	...
	public void executeControlActionTest_2() {
		ControlActionMetadata metadata = new ControlActionMetadata("org.eclipse.score.worker.execution.reflection.ReflectionAdapterTestHelper", "myMethod_2");
		Map<String, Object> map = new HashMap<>();
	...
	public void executeControlActionTest_3() {
		ControlActionMetadata metadata = new ControlActionMetadata("org.eclipse.score.worker.execution.reflection.ReflectionAdapterTestHelper", "myMethod_3");
	...
	public void executeControlActionTest_4() {
		ControlActionMetadata metadata = new ControlActionMetadata("org.eclipse.score.worker.execution.reflection.ReflectionAdapterTestHelperNoSpring", "myMethod_4");
		Map<String, Object> actionData = new HashMap<>();
		actionData.put("parameter_1", 5);
		actionData.put("parameter_2", 3);
		@SuppressWarnings("unchecked")
