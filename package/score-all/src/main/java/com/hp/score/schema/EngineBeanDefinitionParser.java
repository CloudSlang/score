...
import com.hp.score.engine.queue.services.QueueDispatcherServiceImpl;
import com.hp.score.engine.queue.services.QueueListenerImpl;
import com.hp.score.engine.queue.services.QueueStateIdGeneratorServiceImpl;
import com.hp.score.engine.queue.services.ScoreEventFactoryImpl;
import com.hp.score.engine.queue.services.assigner.ExecutionAssignerServiceImpl;
import com.hp.score.engine.queue.services.cleaner.QueueCleanerServiceImpl;
import com.hp.score.engine.queue.services.recovery.ExecutionRecoveryServiceImpl;
import com.hp.score.engine.queue.services.recovery.MessageRecoveryServiceImpl;
import com.hp.score.engine.queue.services.recovery.WorkerRecoveryServiceImpl;
import com.hp.score.engine.versioning.services.VersionServiceImpl;
import com.hp.score.orchestrator.services.CancelExecutionServiceImpl;
...
import com.hp.score.engine.partitions.services.PartitionTemplateImpl;
import com.hp.score.engine.partitions.services.PartitionUtils;
import com.hp.score.orchestrator.services.ScoreDeprecatedImpl;
import com.hp.score.orchestrator.services.ScoreImpl;
