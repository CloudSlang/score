...
public interface MavenConfig {
    ...
    String DEPENDENCY_BUILD_CLASSPATH_COMMAND = "org.apache.maven.plugins:maven-dependency-plugin:3.11.0:build-classpath";
    String DEPENDENCY_GET_COMMAND = "org.apache.maven.plugins:maven-dependency-plugin:3.11.0:get";
