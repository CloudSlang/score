...
/**
 * Created by IntelliJ IDEA. User: kravtsov Date: 30/07/12 Time: 14:29
 */
public class ExecutionPlanCompressUtil {
    ...
    public static ExecutionPlan getExecutionPlanFromBytes(byte[] bytes) {
        ...
        try (ByteArrayInputStream is = new ByteArrayInputStream(bytes);
                ...
                BufferedInputStream bisSecond = new BufferedInputStream(gis);
                ObjectInputStream ois = new ObjectInputStream(bisSecond)) {
    ...
    public static byte[] getBytesFromExecutionPlan(ExecutionPlan executionPlan) {
        try {
            ...
            BufferedOutputStream bosSecond = new BufferedOutputStream(gzipOut);
            ObjectOutputStream oos = new ObjectOutputStream(bosSecond);
