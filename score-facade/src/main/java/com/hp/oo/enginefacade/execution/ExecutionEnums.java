...
public interface ExecutionEnums {
    ...
    enum LogLevelCategory {
        ...
        STEP_NAV_ERROR (EventConstants.SCORE_STEP_NAV_ERROR,  "execution.logEvent.stepNavigationError.title.label",  "execution.logEvent.stepNavigationError.description.label"),
        STEP_SPLIT_ERROR (EventConstants.SCORE_STEP_SPLIT_ERROR,  "execution.logEvent.stepSplitError.title.label",  "execution.logEvent.stepSplitError.description.label"),
