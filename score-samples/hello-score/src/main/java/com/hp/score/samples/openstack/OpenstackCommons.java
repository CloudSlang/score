...
public class OpenstackCommons {
	...
	public static final String FINAL_STEP_ACTIONS_CLASS = "com.hp.score.samples.openstack.actions.FinalStepActions";
	public static final String CONTEXT_MERGER_CLASS = "com.hp.score.samples.openstack.actions.ContextMerger";
	public static final String OPENSTACK_UTILS_CLASS = "com.hp.score.samples.openstack.actions.OpenstackUtils";
