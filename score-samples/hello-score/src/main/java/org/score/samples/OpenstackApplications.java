...
//		prepareExecutionContext(executionContext);
		...
		while(!command.equals("4")) {
			...
			System.out.println("3 - Missing inputs use case");
	...
	private void prepareExecutionContext(Map<String, Serializable> executionContext) {
		...
		*/
		...
		executionContext.put("url", "http://16.59.58.200:5000/v2.0/tokens");
		executionContext.put("method", "post");
		executionContext.put("body", "{\"auth\": {\"tenantName\": \"demo\",\"passwordCredentials\": {\"username\": \"admin\",\"password\": \"stack\"}}}");
		executionContext.put("contentType", "application/json");
	...
	private void createServer(String host, String port, String serverName, String username, String password){
		...
		//String token = executionContext.get("returnResult").toString();
	...
	private void createContextMergerStep(ExecutionPlanBuilder builder) {
		...
		builder.addStep(1L, "org.score.samples.openstack.actions.ContextMerger", "merge", navigationMatchers);
	}
	private void startServerStep(String host, String port, String serverName, ExecutionPlanBuilder builder, Map<String, Serializable> executionContext){
		...
		//executionContext.put("url", "http://16.59.58.200:8774/v2/1ef9a1495c774e969ad6de86e6f025d7/servers");
		executionContext.put("method", "post");
		//executionContext.put("headers", "X-AUTH-TOKEN: " + token);
		//executionContext.put("body", "{\"server\": {\"name\": \"server-test-X\",\"imageRef\": \"56ff0279-f1fb-46e5-93dc-fe7093af0b1a\",\"flavorRef\": \"2\",\"max_count\": 1,\"min_count\": 1,\"security_groups\": [{\"name\": \"default\"}]}}");
		executionContext.put("contentType", "application/json");
		...
		builder.addStep(2L, "org.score.content.httpclient.HttpClientAction", "execute", navigationMatchers);
		builder.addFinalStep(3L, "org.score.samples.openstack.actions.FinalStepActions", "successStepAction");
	}
}
