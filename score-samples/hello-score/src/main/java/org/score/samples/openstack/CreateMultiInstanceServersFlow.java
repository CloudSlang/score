...
import static org.score.samples.openstack.OpenstackCommons.OPENSTACK_UTILS_CLASS;
import static org.score.samples.openstack.OpenstackCommons.GET_MULTI_INSTANCE_RESPONSE_METHOD;
import static org.score.samples.openstack.OpenstackCommons.SERVER_NAMES_LIST_MESSAGE;
import static org.score.samples.openstack.OpenstackCommons.SERVER_NAMES_LIST_KEY;
import static org.score.samples.openstack.OpenstackCommons.SERVER_NAME_KEY;
import static org.score.samples.openstack.OpenstackCommons.SERVER_NAME_MESSAGE;

import static org.score.samples.openstack.OpenstackCommons.SPLIT_SERVERS_INTO_BRANCH_CONTEXTS_METHOD;
import static org.score.samples.openstack.OpenstackCommons.createFailureStep;
import static org.score.samples.openstack.OpenstackCommons.createSuccessStep;
import static org.score.samples.openstack.OpenstackCommons.mergeInputsWithoutDuplicates;
import static org.score.samples.openstack.OpenstackCommons.SUCCESS_RESPONSE;
import static org.score.samples.openstack.OpenstackCommons.RESPONSE_KEY;
