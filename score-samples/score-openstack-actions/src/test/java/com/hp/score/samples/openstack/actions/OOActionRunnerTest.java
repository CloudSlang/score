...
public class OOActionRunnerTest {
	...
	public void testRunWithoutExceptions() throws Exception {
		...
		runAction(actualExecutionContext, new HashMap<String, Object>(), executionRuntimeServicesMock, "com.hp.score.samples.openstack.actions.OOActionRunnerTest", "auxiliaryAction");
	...
	public void testRunWithClassNotFoundException() throws Exception {
		...
		runAction(actualExecutionContext, new HashMap<String, Object>(), executionRuntimeServicesMock, "com.hp.score.samples.openstack.actions.IDontExist", "auxiliaryAction");
